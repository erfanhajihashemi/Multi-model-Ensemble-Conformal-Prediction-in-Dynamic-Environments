...
def pinball_loss_new(alpha_s, alpha_hat, alpha: float):
    return alpha * (alpha_s - alpha_hat) - np.minimum(0, alpha_s - alpha_hat)

def pinball_loss_grad_new(alpha_s, alpha_hat, alpha: float):
    return 1 * (alpha_s < alpha_hat) - alpha
